...
<div class="px-4 py-3">
<div class="relative">
<input id="homeSearch" type="text" placeholder="이벤트, 카페를 검색하세요..."
class="w-full border border-gray-200 rounded-full px-4 py-2"/>
...
<option>전체글</option><option>후기 모음</option><option>서로이웃 구함</option>
<option>맞팔·구독 교환</option><option>꿀팁·Q&A</option><option>사장님 코너</option>
</select>
<label>제목</label>
...
"<option value="""">전체 시/도</option><option>서울특별시</option><option>경기도</option>
<option>부산광역시</option>
<option>대구광역시</option>
<option>인천광역시</option>
<option>광주광역시</option>
...
"<option value="""">전체 카테고리</option><option>맛집</option><option>여행</option>
<option>기타</option>"
</select>
<select id="filterChannel" class="border rounded px-3 py-2 text-sm">
"<option value="""">전체 채널</option><option>블로그</option><option>클립</option>
<option>인스타</option><option>유튜브</option><option>쇼츠</option>
<option>릴스</option><option>틱톡</option>"
</select>
<select id="filterType" class="border rounded px-3 py-2 text-sm">
"<option value="""">전체 유형</option><option>방문형</option><option>포장</option>
<option>구매형</option><option>배송형</option><option>기자단</option>
<option>당일지급</option>"
</select>
<select id="filterSort" class="border rounded px-3 py-2 text-sm">
<option value="">정렬 선택</option><option>최신순</option><option>마감임박순</option>
</select>
</div>
...
<div class="px-4 mb-4">
<div class="flex justify-between mb-2"><h2 class="font-semibold">📌 신청한 체험단</h2><button onclick="alert('TODO')" class="text-sm text-green-500">더보기</button></div>
<ul class="space-y-2"><li class="bg-white p-3 rounded-lg shadow text-sm">체험단 캘린더</li></ul>
</div>
<div class="px-4 mb-4">
<div class="flex justify-between mb-2"><h2 class="font-semibold">🔖 해시태그 설정</h2><button onclick="alert('해시태그 관리')" class="text-sm text-green-500">더보기</button></div>
<div class="flex flex-wrap gap-2 mb-3" id="myTags"></div>
<div class="flex items-center text-sm"><label class="mr-2">추천 ON</label><input type="checkbox" checked class="toggle toggle-sm toggle-green"/></div>
</div>
<div class="px-4 mb-8"><h2 class="font-semibold mb-2">⚙️ 설정 & 기타</h2><ul class="space-y-2 text-sm">
